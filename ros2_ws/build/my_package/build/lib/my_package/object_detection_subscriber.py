# object_detection_env_node.py
import rclpy
from rclpy.node import Node
from my_package.msg import Observation, Reward
...
class ObjectDetectionNode(Node):
    def __init__(self):
        ...
        self.env = ObjectDetectionEnv(self.model_path)
        self.env = DummyVecEnv([lambda: self.env])
        self.model = DQN("MultiInputPolicy", self.env, verbose=1, tensorboard_log="./dqn_logs/")

        self.observation_publisher = self.create_publisher(Observation, 'observation_topic', 10)
        self.reward_publisher = self.create_publisher(Reward, 'reward_topic', 10)
    ...
    def timer_callback(self):
        ...
        msg = Observation()
        msg.silo_states = observation['silo_states']
        msg.ball_color = observation['ball_color']
        msg.team_color = observation['team_color']
